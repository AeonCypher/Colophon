...
4. Configure pending Trusted Publishers before the first upload:
   ...
   - TestPyPI project: `colophon-site`, owner `LibertAiTech`, repository `Colophon`, workflow `publish.yml`, environment `testpypi`.
   - PyPI project: `colophon-site`, owner `LibertAiTech`, repository `Colophon`, workflow `publish.yml`, environment `pypi`.
